...
class MangasController extends Controller
{
    ...
    {
        $dessinateur = $mangas->dessinateur;
        $scenariste = $mangas->scenariste;
        $genre = $mangas->genre;
        $path = 'images/' .$mangas->couverture;
        return view('manga', compact('mangas','dessinateur','scenariste','genre','path'));
    }
